...
% In case of problems of comments, please do not contact the author.
...
%%% PROVIDE ADDRESS RELATED INFORMATION
\address{email na vedoucího: exapmle@example.com}
